<template>
    <footer class="footer">
        <div class="footer-container">
            <div class="col-min">
                <div class="footer__logo">ModalX</div>
                <div class="socials">
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="19px" height="19px" viewBox="0 0 430.113 430.114" style="enable-background:new 0 0 430.113 430.114;" xml:space="preserve">
                            <g>
                    ...
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 612 612" style="enable-background:new 0 0 612 612;" xml:space="preserve" width="19px" height="19px">
                            <g><g>
            ...
            <div class="col-max">
                ...
                <div class="form">
                    <div class="form__title">Subscribe to news</div>
            ...
            <div class="col-min">
                ...
                <span>400 Castro St, San Francisco, CA</span>
                <span>(+1) 686-868-9999</span>
                <div class="cards">
                    <div class="img" style="background-image:url(https://cdn4.iconfinder.com/data/icons/payment-method/160/payment_method_master_card-256.png)"></div>
                    <div class="img" style="background-image:url(https://www.paypalobjects.com/webstatic/mktg/logo-center/PP_Acceptance_Marks_for_LogoCenter_266x142.png)"></div>
                    <div class="img" style="background-image:url(https://www.geek.com/wp-content/uploads/2012/05/Screen-Shot-2012-05-08-at-2.55.35-PM.png)"></div>
                    <div class="img" style="background-image:url( https://vignette.wikia.nocookie.net/uncyclopedia/images/4/4b/Visa.png/revision/latest?cb=20071013130545)"></div>
                    <div class="img" style="background-image:url(https://cdn4.iconfinder.com/data/icons/payment-method/160/payment_method_master_card-256.png)"></div>
                </div>
            </div>
        </div>
